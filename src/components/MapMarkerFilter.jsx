          ...
          >
            ...
            <div className="relative mb-3">
              ...
              <input
                ...
                placeholder="Buscar..."
                className="w-full pl-9 pr-3 py-1.5 border rounded text-sm focus:outline-none focus:ring focus:border-blue-300"
              />
            </div>

            {/* Lista tipos con togglers */}
